    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h4 class="page-title">Pinjam Ruangan</h4>
                <div class="row">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    <div class="btn-group-justified">
                                        <a href="{{ route('transaksi-ruangan-app.show',$item->id) }}" class="btn btn-primary">Detail</a>
                                        <?php if($item->status == 'dipinjam'){ ?>
                                        <a href="#" class="btn btn-success">Pinjam</a>
                                        <?php } else { ?>
                                        <a href="{{ url('pinjam-ruangan/create-transaksi',$item->id) }}" class="btn btn-success">Pinjam</a>
                                        <?php } ?>                                        
