...
class FeedbackAsetController extends BaseController
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        Storage::putFileAs('public/feedbackaset', $request->file('lampiran_foto_1'),$l1);
        $l2 = sha1(date('ymdhis')).'.'.request()->lampiran_foto_2->getClientOriginalExtension();
        Storage::putFileAs('public/feedbackaset', $request->file('lampiran_foto_2'),$l2);
